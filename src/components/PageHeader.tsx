            ...
            <SettingsModal>
              ...
              <li onClick={() => navigate('/invoices')}>
                <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M15 6.6875V14C15 16.25 13.6575 17 12 17H6C4.3425 17 3 16.25 3 14V6.6875C3 4.25 4.3425 3.6875 6 3.6875C6 4.1525 6.18748 4.5725 6.49498 4.88C6.80248 5.1875 7.2225 5.375 7.6875 5.375H10.3125C11.2425 5.375 12 4.6175 12 3.6875C13.6575 3.6875 15 4.25 15 6.6875Z" stroke="#232323" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M12 3.6875C12 4.6175 11.2425 5.375 10.3125 5.375H7.6875C7.2225 5.375 6.80248 5.1875 6.49498 4.88C6.18748 4.5725 6 4.1525 6 3.6875C6 2.7575 6.7575 2 7.6875 2H10.3125C10.7775 2 11.1975 2.1875 11.505 2.495C11.8125 2.8025 12 3.2225 12 3.6875Z" stroke="#232323" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M6 10.25H9" stroke="#232323" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M6 13.25H12" stroke="#232323" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                Invoices
              </li>
              <li onClick={() => navigate('/settings')}>
                <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9 11.75C10.2426 11.75 11.25 10.7426 11.25 9.5C11.25 8.25736 10.2426 7.25 9 7.25C7.75736 7.25 6.75 8.25736 6.75 9.5C6.75 10.7426 7.75736 11.75 9 11.75Z" stroke="#232323" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M1.5 10.1591V8.8391C1.5 8.0591 2.1375 7.4141 2.925 7.4141C4.2825 7.4141 4.8375 6.4541 4.155 5.2766C3.765 4.6016 3.9975 3.7241 4.68 3.3341L5.9775 2.5916C6.57 2.2391 7.335 2.4491 7.6875 3.0416L7.77 3.1841C8.445 4.3616 9.555 4.3616 10.2375 3.1841L10.32 3.0416C10.6725 2.4491 11.4375 2.2391 12.03 2.5916L13.3275 3.3341C14.01 3.7241 14.2425 4.6016 13.8525 5.2766C13.17 6.4541 13.725 7.4141 15.0825 7.4141C15.8625 7.4141 16.5075 8.0516 16.5075 8.8391V10.1591C16.5075 10.9391 15.87 11.5841 15.0825 11.5841C13.725 11.5841 13.17 12.5441 13.8525 13.7216C14.2425 14.4041 14.01 15.2741 13.3275 15.6641L12.03 16.4066C11.4375 16.7591 10.6725 16.5491 10.32 15.9566L10.2375 15.8141C9.5625 14.6366 8.4525 14.6366 7.77 15.8141L7.6875 15.9566C7.335 16.5491 6.57 16.7591 5.9775 16.4066L4.68 15.6641C3.9975 15.2741 3.765 14.3966 4.155 13.7216C4.8375 12.5441 4.2825 11.5841 2.925 11.5841C2.1375 11.5841 1.5 10.9391 1.5 10.1591Z" stroke="#232323" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                Settings
              </li>
              <Divider />
